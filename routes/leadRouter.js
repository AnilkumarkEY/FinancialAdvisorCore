...
async function leadRoutes(fastify, options) {
    ...
    fastify.get('/lead/product-intrested',{ preHandler: [authentication,eventValidation]}, leadControllers.prodcutIntrested);
    fastify.get('/lead/get-lead-list',{ preHandler: [authentication,eventValidation]}, leadControllers.getLeadList);
